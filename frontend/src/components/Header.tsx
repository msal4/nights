...
export default () => {
  ...
  return (
    <nav className="mb-8 py-4 relative z-10 md:flex md:justify-between font-thin">
      ...
      <div
        className={`mt-2 ${
          ...
          } md:block md:flex md:items-center md:mt-0 md:justify-between ${!match ? 'md:w-full' : ''}`}
      >
        {!match && <div className="flex flex-col md:flex-row justify-between md:ml-6 md:text-sm lg:text-base">
