...
export default (props: { className?: string }) => {
  ...
  return <div
    ...
    style={{boxShadow: !searchFocused ? '0 0 0 1px gray' : '0 0 0 1px white'}}>
    <IoIosSearch style={{ minWidth: "1rem" }} size="1.5em" color={searchFocused ? 'white' : 'gray'}/>
    <input className="bg-transparent text-sm w-full mx-2 font-thin" type="text"
           placeholder="Search" onFocus={focusSearch} onBlur={blurSearch}
    />
  </div>
}